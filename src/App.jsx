...
function Footer() {
  const devopsTools = [
    { name: 'IP Lookup', url: 'https://whatismyipaddress.com' },
    { name: 'DNS Checker', url: 'https://mxtoolbox.com' },
    { name: 'Port Scanner', url: 'https://www.portscan.org' },
    { name: 'Regex Tester', url: 'https://regex101.com' },
    { name: 'JSON Viewer', url: 'https://jsoncrack.com' },
    { name: 'YAML Parser', url: 'https://www.yamllint.com' }
  ]

  const windowsTools = [
    { name: 'Intune Admin', url: 'https://intune.microsoft.com' },
    { name: 'Active Directory', url: 'https://aad.portal.azure.com' },
    { name: 'Microsoft 365', url: 'https://admin.microsoft.com' },
    { name: 'Azure Portal', url: 'https://portal.azure.com' },
    { name: 'Endpoint Manager', url: 'https://endpoint.microsoft.com' },
    { name: 'Group Policy', url: 'https://docs.microsoft.com/en-us/windows-server/administration/windows-commands/gpresult' }
  ]

  return (
    <div style={styles.footer}>
      <div style={styles.footerSection}>
        <p style={{margin: '0 0 10px', fontSize: '12px', color: '#38bdf8', fontWeight: 'bold'}}>DevOps & Infrastructure Tools</p>
        <div style={{display: 'flex', flexWrap: 'wrap', gap: '8px'}}>
          {devopsTools.map((tool, i) => (
            <a key={i} href={tool.url} target="_blank" rel="noopener noreferrer" style={styles.footerBtn}>
              {tool.name}
            </a>
          ))}
        </div>
      ...
      <div style={styles.footerSection}>
        <p style={{margin: '0 0 10px', fontSize: '12px', color: '#38bdf8', fontWeight: 'bold'}}>Windows Admin Tools</p>
        <div style={{display: 'flex', flexWrap: 'wrap', gap: '8px'}}>
          {windowsTools.map((tool, i) => (
            <a key={i} href={tool.url} target="_blank" rel="noopener noreferrer" style={styles.footerBtn}>
              {tool.name}
            </a>
          ))}
